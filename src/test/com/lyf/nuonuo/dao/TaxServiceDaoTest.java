...
import com.lyf.nuonuo.entity.TaxService;
...
public class TaxServiceDaoTest extends BaseTest{
    /**
     * The Service ids.
     */
    ...
    public void insert() throws Exception {
        ...
        for(CompanyCardAudit cardAudit:companyCardAuditList){
            ...
            taxService.setTaxId(cardAudit.getTaxid());
            taxService.setServiceId(serviceIds[(i++)*i%150]);
            taxServiceList.add(taxService);
        }
        taxServiceDao.insertTaxService(taxServiceList);
    }
